                            ...
                            <div className="col">
                                <div className="card mt-2 text-center">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <span className={"badge ml-1 " + (this.state.faturamento.anterior.comparativo > 0 ? "bg-success" : "bg-danger")}>
                            ...
                            <div className="col">
                                <div className="card mt-2 text-center">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <span className={"badge ml-1 " + (this.state.faturamento.previsao.comparativo > 0 ? "bg-success" : "bg-danger")}>
